...
#[doc = "EVENTS_NOTRESOLVED (rw) register accessor: Address not resolved\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_notresolved::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_notresolved::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@events_notresolved`]
module"]
...
#[doc = "Enable AAR"]
pub mod enable;
#[doc = "NIRK (rw) register accessor: Number of IRKs\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`nirk::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`nirk::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@nirk`]
module"]
#[doc(alias = "NIRK")]
pub type Nirk = crate::Reg<nirk::NirkSpec>;
#[doc = "Number of IRKs"]
pub mod nirk;
#[doc = "IRKPTR (rw) register accessor: Pointer to IRK data structure\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`irkptr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`irkptr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@irkptr`]
module"]
#[doc(alias = "IRKPTR")]
pub type Irkptr = crate::Reg<irkptr::IrkptrSpec>;
#[doc = "Pointer to IRK data structure"]
pub mod irkptr;
#[doc = "ADDRPTR (rw) register accessor: Pointer to the resolvable address\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`addrptr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`addrptr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@addrptr`]
module"]
#[doc(alias = "ADDRPTR")]
