...
#[doc = "WA (rw) register accessor: Description cluster: Write access to peripheral region n detected\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wa::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wa::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@wa`]
module"]
#[doc(alias = "WA")]
