...
#[doc = "Description cluster: Reserved for future use"]
pub mod end;
#[doc = "SUBS (rw) register accessor: Description cluster: Subregions of region n\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`subs::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`subs::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@subs`]
module"]
#[doc(alias = "SUBS")]
