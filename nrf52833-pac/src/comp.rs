...
pub mod extrefsel;
#[doc = "TH (rw) register accessor: Threshold configuration for hysteresis unit\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`th::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`th::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@th`]
module"]
#[doc(alias = "TH")]
