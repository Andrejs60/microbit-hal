...
#[doc = "Description collection: Number of bytes received last in the data stage of this OUT endpoint\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`epout::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`epout::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
