...
#[doc = "A valid SETUP token has been received (and acknowledged) on the control endpoint\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_ep0setup::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_ep0setup::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
