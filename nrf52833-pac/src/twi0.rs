...
#[doc = "EVENTS_RXDREADY (rw) register accessor: TWI RXD byte received\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_rxdready::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_rxdready::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@events_rxdready`]
module"]
...
#[doc = "EVENTS_BB (rw) register accessor: TWI byte boundary, generated before each byte that is sent or received\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_bb::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_bb::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@events_bb`]
module"]
#[doc(alias = "EVENTS_BB")]
...
#[doc = "Unspecified"]
pub mod psel;
#[doc = "RXD (r) register accessor: RXD register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rxd::R`]. WARN: One or more dependent resources other than the current register are immediately affected by a read operation. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rxd`]
module"]
#[doc(alias = "RXD")]
