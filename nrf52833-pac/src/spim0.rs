...
#[doc = "Unspecified"]
pub mod iftiming;
#[doc = "CSNPOL (rw) register accessor: Polarity of CSN output\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`csnpol::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`csnpol::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@csnpol`]
module"]
#[doc(alias = "CSNPOL")]
pub type Csnpol = crate::Reg<csnpol::CsnpolSpec>;
#[doc = "Polarity of CSN output"]
pub mod csnpol;
#[doc = "PSELDCX (rw) register accessor: Pin select for DCX signal\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pseldcx::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pseldcx::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pseldcx`]
module"]
#[doc(alias = "PSELDCX")]
pub type Pseldcx = crate::Reg<pseldcx::PseldcxSpec>;
#[doc = "Pin select for DCX signal"]
pub mod pseldcx;
#[doc = "DCXCNT (rw) register accessor: DCX configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dcxcnt::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dcxcnt::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dcxcnt`]
module"]
#[doc(alias = "DCXCNT")]
