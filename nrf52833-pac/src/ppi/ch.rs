...
#[doc = "EEP (rw) register accessor: Description cluster: Channel n event endpoint\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eep::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`eep::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@eep`]
module"]
#[doc(alias = "EEP")]
