...
#[doc = "EVENTS_USBDETECTED (rw) register accessor: Voltage supply detected on VBUS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_usbdetected::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_usbdetected::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@events_usbdetected`]
module"]
...
#[doc = "EVENTS_USBREMOVED (rw) register accessor: Voltage supply removed from VBUS\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_usbremoved::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_usbremoved::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@events_usbremoved`]
module"]
...
#[doc = "EVENTS_USBPWRRDY (rw) register accessor: USB 3.3 V supply ready\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`events_usbpwrrdy::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`events_usbpwrrdy::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@events_usbpwrrdy`]
module"]
...
pub mod systemoff;
#[doc = "POFCON (rw) register accessor: Power-fail comparator configuration\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pofcon::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pofcon::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pofcon`]
module"]
#[doc(alias = "POFCON")]
...
pub mod gpregret;
#[doc = "GPREGRET2 (rw) register accessor: General purpose retention register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpregret2::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpregret2::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@gpregret2`]
module"]
#[doc(alias = "GPREGRET2")]
...
pub mod dcdcen;
#[doc = "MAINREGSTATUS (r) register accessor: Main supply status\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mainregstatus::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mainregstatus`]
module"]
